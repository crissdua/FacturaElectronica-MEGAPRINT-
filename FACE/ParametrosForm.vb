...
#Region "Codigo General"
    ...
    Private Sub LlenaGrid()
        ...
        Try
            ...
            QryStr = "select  a.Series,a.SeriesName," &
                     ...
                     "U_RESOLUCION Resolucion,U_AUTORIZACION IDserie,U_FECHA_AUTORIZACION Fecha, U_FACTURA_DEL 'De la Factura', U_FACTURA_AL 'A la factura',  " &
                     "b.U_TIPO_DOC 'Tipo Documento','Es batch' = Case isnull(b.U_ES_BATCH, '100') WHEN '100' THEN '0' ELSE 'Y' End ,b.U_SUCURSAL '# Sucursal',b.U_NOMBRE_SUCURSAL 'Empresa', b.U_DISPOSITIVO '# Dispositivo',    " &
                     "b.U_DIR_SUCURSAL 'Direccion Sucursal',b.U_MUNI_SUCURSAL Municipio, b.U_DEPTO_SUCURSAL Departamento,b.U_USUARIO 'Usuario GFACE', b.U_CLAVE 'Clave GFACE' " &
                     "from NNM1 a left outer join [@FACE_RESOLUCION] b " &
