...
Public Class BatchForm
    ...
    Private Sub LlengaGrid(ByVal Serie As String, ByVal incluirRechazadas As Boolean, ByVal del As String, ByVal al As String)
        ...
        Try
            ...
            If Utils.Empresa = EmpresaFACE.LLAMASA Or Utils.Empresa = EmpresaFACE.QUALIPHARM Or Utils.Empresa = EmpresaFACE.FFACSA Or Utils.Empresa = EmpresaFACE.PRINTER Or Utils.Empresa = EmpresaFACE.Generico Then
