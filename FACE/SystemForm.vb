...
#Region "INICIALIZA CONEXION CON SAP"
    ...
    Private Sub AddUserTables()
        Try
            ...
            Utils.AddUserField(oCompany, "OCRD", "nit", "nit", SAPbobsCOM.BoFieldTypes.db_Alpha, 25, False)
            ...
            Utils.AddUserField(oCompany, "ORIN", "NO_FACTURA", "NO. FACTURA", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, False)
            Utils.AddUserField(oCompany, "ORIN", "SERIE_FACTURA", "SERIE FACTURA", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, False)
            Utils.AddUserField(oCompany, "ORIN", "FECHA_FACTURA", "FECHA FACTURA", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, False)
            Utils.AddUserField(oCompany, "ORIN", "CONCEPTO_FACTURA", "CONCEPTO FACTURA", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, False)
            ...
            ElseIf Utils.TipoGFACE = TipoFACE.MegaPrinter Then
                Utils.AddDocumentType(oCompany, "1", "Factura electroónica", 1)
                Utils.AddDocumentType(oCompany, "2", "Nota De Credito Electrónica", 1)
                Utils.AddDocumentType(oCompany, "3", "Nota De Débito Electrónica", 1)
            End If
